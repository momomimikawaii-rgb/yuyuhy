...
const monthThemes = {
 ...
 6:"梅雨の夢池。オオオニバスの葉っぱの上、周囲にスイレン、スイレンの葉の傘、お天気雨、紫陽花控えめ、雨粒キラキラ。体は人形・ぬいぐるみのような自然な直立ボディ。犬の骨格のまま無理に二足立ちさせないでください。腰が後ろに出た犬型二足立ちは禁止。スイレンの葉の傘は、丸いペットらしい手で自然に持たせてください。",
